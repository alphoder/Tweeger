          ...
          {loading ? (
            ...
            <div className="py-16 text-center">
              ...
              <p className="mt-1 text-sm text-zinc-600">
                Run <span className="font-mono text-amber-400">/build</span> or{" "}
                <span className="font-mono text-amber-400">/doitdeep</span> on Telegram — the team
                      ...
                      <div className="mt-2 space-y-2">
                        {m.attachments.map((a, i) => {
                          ...
                          return (
                            <div
                              key={i}
                              className="cursor-pointer rounded-lg border border-zinc-800 bg-zinc-950/70 p-3 transition-colors hover:border-amber-400/40"
